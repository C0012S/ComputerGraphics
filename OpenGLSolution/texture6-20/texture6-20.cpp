#include <windows.h>
#include <stdio.h>
#include <GL\glu.h>    // GL 폴더 추가
#include <GL\glut.h>
#include <GL\glaux.h>
// 종속성에 glaux.lib, legacy_stdio_definitions.lib 추가
// 속성 -> 고급 -> 문자집합 -> 멀티바이트 문자집합
// 속성 -> C/C++ -> 전처리기 -> 전처리기정의 -> _CRT_SECURE_NO_WARNINGS 추가
...
void LoadGLTextures() {
    ...
    if ((TextureImage[0] = LoadBMP((char*)"Background.bmp")) && // 형 변환
        (TextureImage[1] = LoadBMP((char*)"SphereMap.bmp"))) {
