...
char texture_name[TEXTURE_NUM][20] = { "multi_photo.bmp" };
...
void MyDisplay() {
    ...
    glEnd(); //추가 //분리함으로써 뒤에 Texture 추가할 수 있음

    glBindTexture(GL_TEXTURE_2D, texture[1]); //추가
    glBegin(GL_QUADS); //추가
